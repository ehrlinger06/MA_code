...
from cosima_core.util.util_functions import log, create_protobuf_msg, get_dict_from_protobuf_message, start_omnet, check_omnet_connection, stop_omnet
...
class CommSimulator(mosaik_api.Simulator):
    ...
    def init(self, sid, time_resolution=1., **sim_params):
        ...
        # NEU
        #self.omnet_process = start_omnet('qtenv', 'EventBasedTCP_LargeCosimaNetwork')
