...
from blackstart.cosima.cosima_core.messages.message_pb2 import CosimaMsgGroup, InitialMessage, InfoMessage, SynchronisationMessage, \
    InfrastructureMessage
import blackstart.cosima.cosima_core.config as cfg
