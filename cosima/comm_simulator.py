...
from blackstart.cosima.cosima_core.config import USED_STEP_SIZE, CONNECT_ATTR, TIME_BASED, SIMULATION_END
from blackstart.cosima.cosima_core.messages.message_pb2 import InitialMessage, InfoMessage, SynchronisationMessage, \
    InfrastructureMessage
from blackstart.cosima.cosima_core.simulators.omnetpp_connection import OmnetppConnection
from blackstart.cosima.cosima_core.util.util_functions import log, create_protobuf_msg, get_dict_from_protobuf_message, start_omnet, check_omnet_connection, stop_omnet
...
class CommSimulator(mosaik_api.Simulator):
    ...
    def init(self, sid, time_resolution=1., **sim_params):
        ...
        # NEU
        self.omnet_process = start_omnet('cmd', 'EventBasedTCP_LargeCosimaNetwork')
        check_omnet_connection(4242)
        time.sleep(2)
        # ENDE NEU
    ...
    def send_message_to_omnetpp(self, messages):
        ...
        if self._omnetpp_connection.is_still_connected:
            ...
            print("in send_message_to_omnetpp")
            self.finalize()
    ...
    def step(self, time, inputs, max_advance):
        print("step of cosima")
        print("max_advance:")
        print(max_advance)
        print("end max_advance")
        self._steps += 1
    ...
    def finalize(self):
        ...
        print("in finalize of CommSim")
        self._omnetpp_connection.close_connection()
        # NEU
        stop_omnet(self.omnet_process)
        # ENDE NEU
